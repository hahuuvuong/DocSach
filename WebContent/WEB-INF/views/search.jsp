			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-4 col-sm-4 col-7 col-lg-2">
						<div class="logo">
							<a href="main.htm"> <img src="images/logo/logo.png"
								alt="logo images">
							</a>
						</div>
					</div>
									...
									<div class="megamenu mega04">
										...
										<ul class="item item03">
											<c:forEach var="u" items="${categories}" begin="${count}"
												...
												<li><a href="theloai/${u.idTheLoai}.htm">${u.tenTheLoai }
												</a></li>
											</c:forEach>
										</ul>
									...
									<c:forEach var="u" items="${truyens}">
										<div
											...
											<div class="product__content content--center">
												<h3>
													<a href="truyen/${u.idSach}.htm">${u.tenSach}</a>
												</h3>
												<h4>
													<a href="truyen/${u.idSach}.htm"><%-- ${u.tacGia} --%></a>
												</h4>
												<div class="action">
													<div class="actions_inner">
														<ul class="add_to_links">
															...
															<li><a title="Xem sau"
																class="quickview modal-view detail-link"
																href="favbook/${u.idSach}.htm" target="_blank"> <i
