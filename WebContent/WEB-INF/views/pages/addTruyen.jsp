						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form:errors path="*" element="ul"/>
									<div class="row">
										  <c:if test = "${truyen.idSach !=0}">
										  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
											<label for="validationCustom01">ID truyen</label> <form:input path="idSach" type="text" class="form-control" readonly="true"  id="validationCustom01" placeholder="Nhập tên truyện" />
											<div class="valid-feedback">Looks good!</div>
										</div>
										    </c:if>
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
											<label for="validationCustom01">Tên truyện</label> <form:input path="TenSach" type="text" class="form-control" id="validationCustom01" placeholder="Nhập tên truyện" />
											<div class="valid-feedback">Looks good!</div>
										</div>
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
											<label for="validationCustom01">Link image</label> <form:input path = "HinhAnh"
										...
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
											<div class="md-form">
												<i class="fas fa-pencil-alt prefix"></i> <label for="form10">Tóm
													tắt</label>
												<form:textarea path = "GioiThieu" id="form10" class="md-textarea form-control"
