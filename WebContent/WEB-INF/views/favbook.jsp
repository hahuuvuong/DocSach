...
<link rel="stylesheet"
	href="assets/vendor/fonts/fontawesome/css/fontawesome.css">
<!-- Cusom css -->
										...
										<c:forEach var="u" items="${listFavBook}">
											<tr>
												<td class="product-thumbnail"><a href="#"><img
														src="${u.hinhAnh}" alt="product img"></a></td>
												<td class="product-name"><a
													href="truyen/${u.idSach}.htm">${u.tenSach}</a></td>
												<td class="product-price"><span class="amount"><c:forEach
															var="t" items="${u.tacgias}">
															<a href="">${t.tenTacGia}</a>
												</c:forEach> </span></td>
												<td class="product-subtotal"><a
													href="theloai/${u.idTheLoai.idTheLoai}/1.htm">${u.idTheLoai.tenTheLoai}</a></td>
												<td class="product-remove"><a
													href="favbook/delete/${u.idSach}.htm"><i
